"""Plugin for Dplay channels such as Kanal 5, Kanal 9 and Kanal 11."""
...
# Regular expressions for url and parsing of video ID
_url_re = re.compile ('(http(s)?://)?www.dplay.se/')
_videoid_re = re.compile ("<link rel='shortlink' href='http://www.dplay.se/\?p=(?P<id>\d+)")
...
class Dplay (Plugin):
    ...
    def _get_streams (self):
        ...
        res = http.get ('http://geo.dplay.se/geo.js', headers=hdr)

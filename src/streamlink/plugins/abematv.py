...
class AbemaTVLicenseAdapter(BaseAdapter):
    ...
    def _getVideoKeyFromTicket(self, ticket):
        ...
        str_table = "123456789ABCDEFGHJKLMNPQRSTUVWXYZabcdefghijkmnopqrstuvwxyz"
        res = sum([str_table.find(key[i]) * (58 ** (len(key) - 1 - i))  for i in range(len(key))])
        ...
        h = hmac.new(unhexlify(b"3AF0298C219469522A313570E8583005A642E73EDD58E3EA2FB7339D3DF1597E"), (cid+deviceId).encode("utf-8"), digestmod=hashlib.sha256)
        enckey = h.digest()

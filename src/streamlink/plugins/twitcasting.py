...
class TwitCasting(Plugin):
    ...
    def _get_streams(self):
        ...
        if websocket:
            yield from self._get_streams_websocket(websocket["streams"])
        if hls:
            yield from self._get_streams_hls(hls["streams"])

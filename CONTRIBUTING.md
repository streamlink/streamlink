...
1. **Human involvement**
    ...
    We do not accept contributions created by automated scripts, AI agents, or users acting as passive copy-paste relays for AI tools.

    Furthermore, contributions must address genuine, practical needs. We do not accept pull requests generated by running automated scans over the codebase to fix theoretical, obscure, or non-impactful pseudo-bugs.

    Issue and pull request descriptions must be written directly by a human to explain why the change is necessary for real-world usage.

2. **Mandatory disclosure**

    You must disclose any level of AI assistance used in your contribution (code, documentation, etc.). This includes fully AI-generated code sections or code refactors, help from AI-based code completions, as well as translated text within issues or pull request descriptions.

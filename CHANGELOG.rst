...
If you think that this application is helpful, please consider supporting the maintainers by donating via the Open Collective (https://opencollective.com/streamlink). You can not only becoming a backer, but also a sponsor for the (open source) project.

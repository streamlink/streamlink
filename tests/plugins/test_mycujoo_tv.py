...
class TestPluginMycujooTv(unittest.TestCase):
    def test_can_handle_url(self):
        ...
        self.assertTrue(MycujooTv.can_handle_url("https://mycujoo.tv/video/example?abc=cde&vid=123"))
        self.assertTrue(MycujooTv.can_handle_url("http://mycujoo.tv/video/example?abc=cde&vid=123"))
        ...
        self.assertTrue(MycujooTv.can_handle_url("https://mycujoo.tv/video/example?abc=cde&vid=123&fgh=ijk"))
        self.assertTrue(MycujooTv.can_handle_url("http://mycujoo.tv/video/example?abc=cde&vid=123&fgh=ijk"))
    ...
    def test_can_handle_url_negative(self):
        ...
        self.assertFalse(MycujooTv.can_handle_url("https://mycujoo.tv/video/vid=123"))
        self.assertFalse(MycujooTv.can_handle_url("http://mycujoo.tv/video/vid=123"))
        self.assertFalse(MycujooTv.can_handle_url("https://mycujoo.tv/video/?id=123"))
        self.assertFalse(MycujooTv.can_handle_url("http://mycujoo.tv/video/?id=123"))
        self.assertFalse(MycujooTv.can_handle_url("https://mycujoo.tv/video/?vid=123"))
        self.assertFalse(MycujooTv.can_handle_url("http://mycujoo.tv/video/?vid=123"))

...
class TestPluginUserInput:
    ...
    @pytest.fixture
    def console_input(self, request, session):
        # type: (Streamlink)
        isatty = request.param  # type: bool
    ...
    def test_user_input_not_implemented(self, testplugin):
        # type: (_TestPlugin)
    ...
    def test_user_input_console(self, testplugin, console_input):
        # type: (_TestPlugin, ConsoleUserInputRequester)
    ...
    def test_user_input_console_no_tty(self, testplugin, console_input):
        # type: (_TestPlugin, ConsoleUserInputRequester)
        with pytest.raises(FatalPluginError) as cm:

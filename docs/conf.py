...
if "no_intersphinx" in tags:  # type: ignore[name-defined, ty:unresolved-reference]  # ruff: ignore[undefined-name]
...
if "no_github_buttons" in tags:  # type: ignore[name-defined, ty:unresolved-reference]  # ruff: ignore[undefined-name]
...
if "man" not in tags:  # type: ignore[name-defined, ty:unresolved-reference]  # ruff: ignore[undefined-name]
